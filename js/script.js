...
/**
 * Función para mostar contraseña
 */
...
/**
 * Función para validarCampos generales
...
/**
 * Función para validar la seleccion del DNI y desbloquear la escritura
 * @param {element} contenedor 
 * @param {string} campo 
 * @param {string} error 
 */
...
/**
 * Función para validar el tipo de cuenta
 * @param {string} campo 
 * @param {string} error 
 */
...
/**
 * Función para validar las aficiones
 * @param {string} campo 
 * @param {string} error 
 */
...
/**
 * Función para validar el canal y cambiar el logo dependiendo del url
 * @param {element} contenedor 
 * @param {string} campo 
 * @param {string} errorRequired 
...
/**
 * Add event listener del botón final para validar los campos y lanzar la creación del nodo final
 */
...
/**
 * Función para comprobar que todos los campos estan en true
 */
